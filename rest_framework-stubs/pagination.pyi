...
class PageNumberPagination(BasePagination):
    ...
    def paginate_queryset(
        self, queryset: QuerySet[Any] | MongoQuerySet[Any], request: Request, view: Optional[APIView] = ...
    ) -> Optional[List[Page]]: ...
...
class LimitOffsetPagination(BasePagination):
    ...
    @overload
    def paginate_queryset(
        self, queryset: QuerySet[_T], request: Request, view: Optional[APIView] = ...
    ) -> Optional[List[_T]]: ...
    @overload
    def paginate_queryset(
