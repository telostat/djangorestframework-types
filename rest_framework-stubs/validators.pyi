...
class UniqueValidator:
    ...
    lookup: str
    def __init__(self, queryset: QuerySet[Any], message: Optional[str] = ..., lookup: str = ...) -> None: ...
...
class UniqueTogetherValidator:
    ...
    queryset: QuerySet[Any]
    fields: Iterable[str]
    def __init__(self, queryset: QuerySet[Any], fields: Iterable[str], message: Optional[str] = ...) -> None: ...
...
class BaseUniqueForValidator:
    ...
    field: str
    date_field: str
    def __init__(self, queryset: QuerySet[Any], field: str, date_field: str, message: Optional[str] = ...) -> None: ...
